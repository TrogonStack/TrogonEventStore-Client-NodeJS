const {TrogonEventStoreClient} = require("@trogonstack/trogon-eventstore-client");
...
(async () => {
    ...
    const bench = new Bench({
        ...
        setup: async () => {
            ...
            client = TrogonEventStoreClient.connectionString`esdb://localhost:2113?tls=false`
        }
    })
