...
var event_store_protocols_v1_persistentsubscriptions_pb = require('../../../event_store/protocols/v1/persistentsubscriptions_pb.js');
...
function serialize_event_store_client_persistent_subscriptions_CreateReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.CreateReq)) {
...
function deserialize_event_store_client_persistent_subscriptions_CreateReq(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.CreateReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_CreateResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.CreateResp)) {
...
function deserialize_event_store_client_persistent_subscriptions_CreateResp(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.CreateResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_DeleteReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.DeleteReq)) {
...
function deserialize_event_store_client_persistent_subscriptions_DeleteReq(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.DeleteReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_DeleteResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.DeleteResp)) {
...
function deserialize_event_store_client_persistent_subscriptions_DeleteResp(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.DeleteResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_GetInfoReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.GetInfoReq)) {
...
function deserialize_event_store_client_persistent_subscriptions_GetInfoReq(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.GetInfoReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_GetInfoResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.GetInfoResp)) {
...
function deserialize_event_store_client_persistent_subscriptions_GetInfoResp(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.GetInfoResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_ListReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.ListReq)) {
...
function deserialize_event_store_client_persistent_subscriptions_ListReq(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.ListReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_ListResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.ListResp)) {
...
function deserialize_event_store_client_persistent_subscriptions_ListResp(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.ListResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_ReadReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.ReadReq)) {
...
function deserialize_event_store_client_persistent_subscriptions_ReadReq(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.ReadReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_ReadResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.ReadResp)) {
...
function deserialize_event_store_client_persistent_subscriptions_ReadResp(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.ReadResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_ReplayParkedReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.ReplayParkedReq)) {
...
function deserialize_event_store_client_persistent_subscriptions_ReplayParkedReq(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.ReplayParkedReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_ReplayParkedResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.ReplayParkedResp)) {
...
function deserialize_event_store_client_persistent_subscriptions_ReplayParkedResp(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.ReplayParkedResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_TruncateParkedReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.TruncateParkedReq)) {
    throw new Error('Expected argument of type event_store.client.persistent_subscriptions.TruncateParkedReq');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_event_store_client_persistent_subscriptions_TruncateParkedReq(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.TruncateParkedReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_TruncateParkedResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.TruncateParkedResp)) {
    throw new Error('Expected argument of type event_store.client.persistent_subscriptions.TruncateParkedResp');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_event_store_client_persistent_subscriptions_TruncateParkedResp(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.TruncateParkedResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_UpdateReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.UpdateReq)) {
...
function deserialize_event_store_client_persistent_subscriptions_UpdateReq(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.UpdateReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_persistent_subscriptions_UpdateResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_persistentsubscriptions_pb.UpdateResp)) {
...
function deserialize_event_store_client_persistent_subscriptions_UpdateResp(buffer_arg) {
  return event_store_protocols_v1_persistentsubscriptions_pb.UpdateResp.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var PersistentSubscriptionsService = exports.PersistentSubscriptionsService = {
  create: {
    ...
    requestType: event_store_protocols_v1_persistentsubscriptions_pb.CreateReq,
    responseType: event_store_protocols_v1_persistentsubscriptions_pb.CreateResp,
  ...
  update: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: event_store_protocols_v1_persistentsubscriptions_pb.UpdateReq,
    responseType: event_store_protocols_v1_persistentsubscriptions_pb.UpdateResp,
  ...
  delete: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: event_store_protocols_v1_persistentsubscriptions_pb.DeleteReq,
    responseType: event_store_protocols_v1_persistentsubscriptions_pb.DeleteResp,
  ...
  read: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: event_store_protocols_v1_persistentsubscriptions_pb.ReadReq,
    responseType: event_store_protocols_v1_persistentsubscriptions_pb.ReadResp,
  ...
  getInfo: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: event_store_protocols_v1_persistentsubscriptions_pb.GetInfoReq,
    responseType: event_store_protocols_v1_persistentsubscriptions_pb.GetInfoResp,
  ...
  replayParked: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: event_store_protocols_v1_persistentsubscriptions_pb.ReplayParkedReq,
    responseType: event_store_protocols_v1_persistentsubscriptions_pb.ReplayParkedResp,
  ...
  truncateParked: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: event_store_protocols_v1_persistentsubscriptions_pb.TruncateParkedReq,
    responseType: event_store_protocols_v1_persistentsubscriptions_pb.TruncateParkedResp,
    requestSerialize: serialize_event_store_client_persistent_subscriptions_TruncateParkedReq,
    requestDeserialize: deserialize_event_store_client_persistent_subscriptions_TruncateParkedReq,
    responseSerialize: serialize_event_store_client_persistent_subscriptions_TruncateParkedResp,
    responseDeserialize: deserialize_event_store_client_persistent_subscriptions_TruncateParkedResp,
  },
  list: {
    path: '/event_store.client.persistent_subscriptions.PersistentSubscriptions/List',
    requestStream: false,
    responseStream: false,
    requestType: event_store_protocols_v1_persistentsubscriptions_pb.ListReq,
    responseType: event_store_protocols_v1_persistentsubscriptions_pb.ListResp,
