...
export class MemberInfo extends jspb.Message {
    ...
    getInstanceId(): event_store_protocols_v1_shared_pb.UUID | undefined;
    setInstanceId(value?: event_store_protocols_v1_shared_pb.UUID): MemberInfo;
    getTimeStamp(): string;
...
export namespace MemberInfo {
    export type AsObject = {
        instanceId?: event_store_protocols_v1_shared_pb.UUID.AsObject,
        timeStamp: string,
