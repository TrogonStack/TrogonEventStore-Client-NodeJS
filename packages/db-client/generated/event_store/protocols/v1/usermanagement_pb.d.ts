...
export class CurrentReq extends jspb.Message {

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): CurrentReq.AsObject;
    static toObject(includeInstance: boolean, msg: CurrentReq): CurrentReq.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: CurrentReq, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): CurrentReq;
    static deserializeBinaryFromReader(message: CurrentReq, reader: jspb.BinaryReader): CurrentReq;
}

export namespace CurrentReq {
    export type AsObject = {
    }
}

export class CurrentResp extends jspb.Message {

    hasUserDetails(): boolean;
    clearUserDetails(): void;
    getUserDetails(): DetailsResp.UserDetails | undefined;
    setUserDetails(value?: DetailsResp.UserDetails): CurrentResp;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): CurrentResp.AsObject;
    static toObject(includeInstance: boolean, msg: CurrentResp): CurrentResp.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: CurrentResp, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): CurrentResp;
    static deserializeBinaryFromReader(message: CurrentResp, reader: jspb.BinaryReader): CurrentResp;
}

export namespace CurrentResp {
    export type AsObject = {
