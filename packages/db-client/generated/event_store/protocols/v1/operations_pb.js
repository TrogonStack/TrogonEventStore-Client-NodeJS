// source: event_store/protocols/v1/operations.proto
/**
 * @fileoverview
 * @enhanceable
...
goog.exportSymbol('proto.event_store.client.operations.ScavengeStatusResp', null, global);
goog.exportSymbol('proto.event_store.client.operations.ScavengeStatusResp.ScavengeStatus', null, global);
 ...
 * @constructor
 */
proto.event_store.client.operations.ScavengeStatusResp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.event_store.client.operations.ScavengeStatusResp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.event_store.client.operations.ScavengeStatusResp.displayName = 'proto.event_store.client.operations.ScavengeStatusResp';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.event_store.client.operations.StartScavengeReq.Options.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    throttlePercent: jspb.Message.getFieldWithDefault(msg, 4, 0),
    syncOnly: jspb.Message.getBooleanFieldWithDefault(msg, 5, false)
  };
 ...
 * @return {number}
 */
proto.event_store.client.operations.StartScavengeReq.Options.prototype.getThreshold = function() {
 ...
 * @return {!proto.event_store.client.operations.StartScavengeReq.Options} returns this
 */
proto.event_store.client.operations.StartScavengeReq.Options.prototype.setThreshold = function(value) {
 ...
 * @return {!proto.event_store.client.operations.StartScavengeReq.Options} returns this
 */
proto.event_store.client.operations.StartScavengeReq.Options.prototype.clearThreshold = function() {
 ...
 * @return {boolean}
 */
proto.event_store.client.operations.StartScavengeReq.Options.prototype.hasThreshold = function() {
 ...
 * @return {number}
 */
proto.event_store.client.operations.StartScavengeReq.Options.prototype.getThrottlePercent = function() {
 ...
 * @return {!proto.event_store.client.operations.StartScavengeReq.Options} returns this
 */
proto.event_store.client.operations.StartScavengeReq.Options.prototype.setThrottlePercent = function(value) {
 ...
 * @return {!proto.event_store.client.operations.StartScavengeReq.Options} returns this
 */
proto.event_store.client.operations.StartScavengeReq.Options.prototype.clearThrottlePercent = function() {
 ...
 * @return {boolean}
 */
proto.event_store.client.operations.StartScavengeReq.Options.prototype.hasThrottlePercent = function() {
  return jspb.Message.getField(this, 4) != null;
};


/**
 * optional bool sync_only = 5;
 * @return {boolean}
 */
proto.event_store.client.operations.StartScavengeReq.Options.prototype.getSyncOnly = function() {
 ...
 * @return {!proto.event_store.client.operations.StartScavengeReq.Options} returns this
 */
proto.event_store.client.operations.StartScavengeReq.Options.prototype.setSyncOnly = function(value) {
 ...
 * @return {!Object}
 */
proto.event_store.client.operations.ScavengeStatusResp.prototype.toObject = function(opt_includeInstance) {
  return proto.event_store.client.operations.ScavengeStatusResp.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.event_store.client.operations.ScavengeStatusResp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.event_store.client.operations.ScavengeStatusResp.toObject = function(includeInstance, msg) {
  var f, obj = {
    scavengeId: jspb.Message.getFieldWithDefault(msg, 1, ""),
    scavengeStatus: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.event_store.client.operations.ScavengeStatusResp}
 */
proto.event_store.client.operations.ScavengeStatusResp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.event_store.client.operations.ScavengeStatusResp;
  return proto.event_store.client.operations.ScavengeStatusResp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.event_store.client.operations.ScavengeStatusResp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.event_store.client.operations.ScavengeStatusResp}
 */
proto.event_store.client.operations.ScavengeStatusResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.event_store.client.operations.ScavengeStatusResp.ScavengeStatus} */ (reader.readEnum());
      msg.setScavengeStatus(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.event_store.client.operations.ScavengeStatusResp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.event_store.client.operations.ScavengeStatusResp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.event_store.client.operations.ScavengeStatusResp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.event_store.client.operations.ScavengeStatusResp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getScavengeId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @enum {number}
 */
proto.event_store.client.operations.ScavengeStatusResp.ScavengeStatus = {
  UNKNOWN: 0,
  INPROGRESS: 1,
  STOPPED: 2,
  SUCCESS: 3,
 ...
 * @return {string}
 */
proto.event_store.client.operations.ScavengeStatusResp.prototype.getScavengeId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.event_store.client.operations.ScavengeStatusResp} returns this
 */
proto.event_store.client.operations.ScavengeStatusResp.prototype.setScavengeId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional ScavengeStatus scavenge_status = 2;
 * @return {!proto.event_store.client.operations.ScavengeStatusResp.ScavengeStatus}
 */
proto.event_store.client.operations.ScavengeStatusResp.prototype.getScavengeStatus = function() {
  return /** @type {!proto.event_store.client.operations.ScavengeStatusResp.ScavengeStatus} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.event_store.client.operations.ScavengeStatusResp.ScavengeStatus} value
 * @return {!proto.event_store.client.operations.ScavengeStatusResp} returns this
 */
proto.event_store.client.operations.ScavengeStatusResp.prototype.setScavengeStatus = function(value) {
  return jspb.Message.setProto3EnumField(this, 2, value);
};
