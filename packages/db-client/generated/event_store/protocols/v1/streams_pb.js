// source: event_store/protocols/v1/streams.proto
/**
 * @fileoverview
 * @enhanceable
...
var event_store_protocols_v1_status_pb = require('../../../event_store/protocols/v1/status_pb.js');
goog.object.extend(proto, event_store_protocols_v1_status_pb);
...
proto.event_store.client.streams.ReadReq.Options.prototype.getNoFilter = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_shared_pb.Empty, 8));
};
...
proto.event_store.client.streams.ReadResp.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lastAllStreamPosition: (f = msg.getLastAllStreamPosition()) && event_store_protocols_v1_shared_pb.AllStreamPosition.toObject(includeInstance, f),
...
proto.event_store.client.streams.ReadResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new event_store_protocols_v1_shared_pb.AllStreamPosition;
      reader.readMessage(value,event_store_protocols_v1_shared_pb.AllStreamPosition.deserializeBinaryFromReader);
...
proto.event_store.client.streams.ReadResp.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      event_store_protocols_v1_shared_pb.AllStreamPosition.serializeBinaryToWriter
    );
  }
...
proto.event_store.client.streams.ReadResp.prototype.getLastAllStreamPosition = function() {
  return /** @type{?proto.event_store.client.AllStreamPosition} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_shared_pb.AllStreamPosition, 7));
};
...
proto.event_store.client.streams.AppendReq.Options.toObject = function(includeInstance, msg) {
  var f, obj = {
    streamIdentifier: (f = msg.getStreamIdentifier()) && event_store_protocols_v1_shared_pb.StreamIdentifier.toObject(includeInstance, f),
    revision: jspb.Message.getFieldWithDefault(msg, 2, "0"),
    noStream: (f = msg.getNoStream()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    any: (f = msg.getAny()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    streamExists: (f = msg.getStreamExists()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
...
proto.event_store.client.streams.AppendResp.WrongExpectedVersion.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    noStream2060: (f = msg.getNoStream2060()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    expectedRevision2060: jspb.Message.getFieldWithDefault(msg, 3, 0),
    any2060: (f = msg.getAny2060()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    streamExists2060: (f = msg.getStreamExists2060()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    currentRevision: jspb.Message.getFieldWithDefault(msg, 6, "0"),
    currentNoStream: (f = msg.getCurrentNoStream()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    expectedRevision: jspb.Message.getFieldWithDefault(msg, 8, "0"),
    expectedAny: (f = msg.getExpectedAny()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    expectedStreamExists: (f = msg.getExpectedStreamExists()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    expectedNoStream: (f = msg.getExpectedNoStream()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
...
proto.event_store.client.streams.AppendResp.WrongExpectedVersion.prototype.getExpectedAny = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_shared_pb.Empty, 9));
};
...
proto.event_store.client.streams.AppendResp.WrongExpectedVersion.prototype.getExpectedStreamExists = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_shared_pb.Empty, 10));
};
...
proto.event_store.client.streams.AppendResp.WrongExpectedVersion.prototype.getExpectedNoStream = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_shared_pb.Empty, 11));
};
...
proto.event_store.client.streams.BatchAppendReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    correlationId: (f = msg.getCorrelationId()) && event_store_protocols_v1_shared_pb.UUID.toObject(includeInstance, f),
...
proto.event_store.client.streams.BatchAppendResp.toObject = function(includeInstance, msg) {
  var f, obj = {
    correlationId: (f = msg.getCorrelationId()) && event_store_protocols_v1_shared_pb.UUID.toObject(includeInstance, f),
    error: (f = msg.getError()) && event_store_protocols_v1_status_pb.Status.toObject(includeInstance, f),
...
proto.event_store.client.streams.BatchAppendResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new event_store_protocols_v1_status_pb.Status;
      reader.readMessage(value,event_store_protocols_v1_status_pb.Status.deserializeBinaryFromReader);
      msg.setError(value);
      break;
    case 3:
...
proto.event_store.client.streams.BatchAppendResp.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      event_store_protocols_v1_status_pb.Status.serializeBinaryToWriter
    );
  }
  f = message.getSuccess();
  if (f != null) {
...
proto.event_store.client.streams.BatchAppendResp.Success.toObject = function(includeInstance, msg) {
  var f, obj = {
    currentRevision: jspb.Message.getFieldWithDefault(msg, 1, "0"),
    noStream: (f = msg.getNoStream()) && google_protobuf_empty_pb.Empty.toObject(includeInstance, f),
    position: (f = msg.getPosition()) && event_store_protocols_v1_shared_pb.AllStreamPosition.toObject(includeInstance, f),
...
proto.event_store.client.streams.BatchAppendResp.Success.prototype.getPosition = function() {
  return /** @type{?proto.event_store.client.AllStreamPosition} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_shared_pb.AllStreamPosition, 3));
};
...
proto.event_store.client.streams.BatchAppendResp.prototype.getError = function() {
  return /** @type{?proto.google.rpc.Status} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_status_pb.Status, 2));
};
...
proto.event_store.client.streams.BatchAppendResp.prototype.getStreamIdentifier = function() {
  return /** @type{?proto.event_store.client.StreamIdentifier} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_shared_pb.StreamIdentifier, 4));
};
