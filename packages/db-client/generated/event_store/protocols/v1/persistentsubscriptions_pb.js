// source: event_store/protocols/v1/persistentsubscriptions.proto
/**
 * @fileoverview
 * @enhanceable
...
goog.exportSymbol('proto.event_store.client.persistent_subscriptions.TruncateParkedReq', null, global);
goog.exportSymbol('proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options', null, global);
goog.exportSymbol('proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.StopAtOptionCase', null, global);
goog.exportSymbol('proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.StreamOptionCase', null, global);
goog.exportSymbol('proto.event_store.client.persistent_subscriptions.TruncateParkedResp', null, global);
 ...
 * @constructor
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.event_store.client.persistent_subscriptions.TruncateParkedReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.event_store.client.persistent_subscriptions.TruncateParkedReq.displayName = 'proto.event_store.client.persistent_subscriptions.TruncateParkedReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.oneofGroups_);
};
goog.inherits(proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.displayName = 'proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedResp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.event_store.client.persistent_subscriptions.TruncateParkedResp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.event_store.client.persistent_subscriptions.TruncateParkedResp.displayName = 'proto.event_store.client.persistent_subscriptions.TruncateParkedResp';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.event_store.client.persistent_subscriptions.ReadReq.Options.toObject = function(includeInstance, msg) {
  var f, obj = {
    streamIdentifier: (f = msg.getStreamIdentifier()) && event_store_protocols_v1_shared_pb.StreamIdentifier.toObject(includeInstance, f),
...
proto.event_store.client.persistent_subscriptions.ReadReq.Options.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new event_store_protocols_v1_shared_pb.StreamIdentifier;
      reader.readMessage(value,event_store_protocols_v1_shared_pb.StreamIdentifier.deserializeBinaryFromReader);
...
proto.event_store.client.persistent_subscriptions.ReadReq.Options.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      event_store_protocols_v1_shared_pb.StreamIdentifier.serializeBinaryToWriter
    );
  }
  f = message.getAll();
  if (f != null) {
...
proto.event_store.client.persistent_subscriptions.ReadReq.Options.UUIDOption.toObject = function(includeInstance, msg) {
  var f, obj = {
    structured: (f = msg.getStructured()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    string: (f = msg.getString()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
...
proto.event_store.client.persistent_subscriptions.ReadReq.Options.prototype.getStreamIdentifier = function() {
  return /** @type{?proto.event_store.client.StreamIdentifier} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_shared_pb.StreamIdentifier, 1));
};
...
proto.event_store.client.persistent_subscriptions.ReadReq.Ack.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    event_store_protocols_v1_shared_pb.UUID.toObject, includeInstance)
  };
...
proto.event_store.client.persistent_subscriptions.ReadReq.Ack.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new event_store_protocols_v1_shared_pb.UUID;
      reader.readMessage(value,event_store_protocols_v1_shared_pb.UUID.deserializeBinaryFromReader);
      msg.addIds(value);
      break;
    default:
      reader.skipField();
...
proto.event_store.client.persistent_subscriptions.ReadReq.Ack.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      event_store_protocols_v1_shared_pb.UUID.serializeBinaryToWriter
    );
  }
};
...
proto.event_store.client.persistent_subscriptions.ReadReq.Ack.prototype.getIdsList = function() {
  return /** @type{!Array<!proto.event_store.client.UUID>} */ (
    jspb.Message.getRepeatedWrapperField(this, event_store_protocols_v1_shared_pb.UUID, 2));
};
...
proto.event_store.client.persistent_subscriptions.ReadResp.ReadEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    noPosition: (f = msg.getNoPosition()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    retryCount: jspb.Message.getFieldWithDefault(msg, 5, 0),
    noRetryCount: (f = msg.getNoRetryCount()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
...
proto.event_store.client.persistent_subscriptions.ReadResp.ReadEvent.RecordedEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: (f = msg.getId()) && event_store_protocols_v1_shared_pb.UUID.toObject(includeInstance, f),
    streamIdentifier: (f = msg.getStreamIdentifier()) && event_store_protocols_v1_shared_pb.StreamIdentifier.toObject(includeInstance, f),
...
proto.event_store.client.persistent_subscriptions.ReadResp.ReadEvent.RecordedEvent.prototype.getId = function() {
  return /** @type{?proto.event_store.client.UUID} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_shared_pb.UUID, 1));
};
...
proto.event_store.client.persistent_subscriptions.ReadResp.ReadEvent.RecordedEvent.prototype.getStreamIdentifier = function() {
  return /** @type{?proto.event_store.client.StreamIdentifier} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_shared_pb.StreamIdentifier, 2));
};
...
proto.event_store.client.persistent_subscriptions.CreateReq.StreamOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    start: (f = msg.getStart()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    end: (f = msg.getEnd()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
...
proto.event_store.client.persistent_subscriptions.CreateReq.AllOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    noFilter: (f = msg.getNoFilter()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
...
proto.event_store.client.persistent_subscriptions.CreateReq.AllOptions.FilterOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    count: (f = msg.getCount()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
 ...
 * @return {string}
 */
proto.event_store.client.persistent_subscriptions.UpdateReq.Settings.prototype.getConsumerStrategy = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 16, ""));
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.UpdateReq.Settings} returns this
 */
proto.event_store.client.persistent_subscriptions.UpdateReq.Settings.prototype.setConsumerStrategy = function(value) {
  return jspb.Message.setProto3StringField(this, 16, value);
};
...
proto.event_store.client.persistent_subscriptions.ReplayParkedReq.Options.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    noLimit: (f = msg.getNoLimit()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
 ...
 * @return {!Object}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.prototype.toObject = function(opt_includeInstance) {
  return proto.event_store.client.persistent_subscriptions.TruncateParkedReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    options: (f = msg.getOptions()) && proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.event_store.client.persistent_subscriptions.TruncateParkedReq;
  return proto.event_store.client.persistent_subscriptions.TruncateParkedReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options;
      reader.readMessage(value,proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.deserializeBinaryFromReader);
      msg.setOptions(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.event_store.client.persistent_subscriptions.TruncateParkedReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getOptions();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.serializeBinaryToWriter
    );
  }
};
 ...
 * @const
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.oneofGroups_ = [[2,3],[4,5]];

/**
 * @enum {number}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.StreamOptionCase = {
  STREAM_OPTION_NOT_SET: 0,
  STREAM_IDENTIFIER: 2,
  ALL: 3
};
...
/**
 * @return {proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.StreamOptionCase}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.getStreamOptionCase = function() {
  return /** @type {proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.StreamOptionCase} */(jspb.Message.computeOneofCase(this, proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.oneofGroups_[0]));
};

/**
 * @enum {number}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.StopAtOptionCase = {
  STOP_AT_OPTION_NOT_SET: 0,
  STOP_AT: 4,
  NO_LIMIT: 5
};
...
/**
 * @return {proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.StopAtOptionCase}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.getStopAtOptionCase = function() {
  return /** @type {proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.StopAtOptionCase} */(jspb.Message.computeOneofCase(this, proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.oneofGroups_[1]));
};
 ...
 * @return {!Object}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.toObject = function(opt_includeInstance) {
  return proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.toObject = function(includeInstance, msg) {
  var f, obj = {
    groupName: jspb.Message.getFieldWithDefault(msg, 1, ""),
    streamIdentifier: (f = msg.getStreamIdentifier()) && event_store_protocols_v1_shared_pb.StreamIdentifier.toObject(includeInstance, f),
    all: (f = msg.getAll()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options;
  return proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getGroupName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.getGroupName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options} returns this
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.setGroupName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {?proto.event_store.client.StreamIdentifier}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.getStreamIdentifier = function() {
  return /** @type{?proto.event_store.client.StreamIdentifier} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_shared_pb.StreamIdentifier, 2));
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options} returns this
*/
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.setStreamIdentifier = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.oneofGroups_[0], value);
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options} returns this
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.clearStreamIdentifier = function() {
  return this.setStreamIdentifier(undefined);
};
 ...
 * @return {boolean}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.hasStreamIdentifier = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {?proto.event_store.client.Empty}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.getAll = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_shared_pb.Empty, 3));
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options} returns this
*/
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.setAll = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.oneofGroups_[0], value);
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options} returns this
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.clearAll = function() {
  return this.setAll(undefined);
};
 ...
 * @return {boolean}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.hasAll = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {string}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.getStopAt = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, "0"));
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options} returns this
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.setStopAt = function(value) {
  return jspb.Message.setOneofField(this, 4, proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.oneofGroups_[1], value);
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options} returns this
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.clearStopAt = function() {
  return jspb.Message.setOneofField(this, 4, proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.oneofGroups_[1], undefined);
};
 ...
 * @return {boolean}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.hasStopAt = function() {
  return jspb.Message.getField(this, 4) != null;
};
 ...
 * @return {?proto.event_store.client.Empty}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.getNoLimit = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, event_store_protocols_v1_shared_pb.Empty, 5));
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options} returns this
*/
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.setNoLimit = function(value) {
  return jspb.Message.setOneofWrapperField(this, 5, proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.oneofGroups_[1], value);
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options} returns this
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.clearNoLimit = function() {
  return this.setNoLimit(undefined);
};
 ...
 * @return {boolean}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options.prototype.hasNoLimit = function() {
  return jspb.Message.getField(this, 5) != null;
};
 ...
 * @return {?proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.prototype.getOptions = function() {
  return /** @type{?proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options} */ (
    jspb.Message.getWrapperField(this, proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options, 1));
};


/**
 * @param {?proto.event_store.client.persistent_subscriptions.TruncateParkedReq.Options|undefined} value
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq} returns this
*/
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.prototype.setOptions = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedReq} returns this
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.prototype.clearOptions = function() {
  return this.setOptions(undefined);
};
 ...
 * @return {boolean}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedReq.prototype.hasOptions = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedResp.prototype.toObject = function(opt_includeInstance) {
  return proto.event_store.client.persistent_subscriptions.TruncateParkedResp.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.event_store.client.persistent_subscriptions.TruncateParkedResp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedResp.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedResp}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedResp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.event_store.client.persistent_subscriptions.TruncateParkedResp;
  return proto.event_store.client.persistent_subscriptions.TruncateParkedResp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.event_store.client.persistent_subscriptions.TruncateParkedResp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.event_store.client.persistent_subscriptions.TruncateParkedResp}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedResp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.event_store.client.persistent_subscriptions.TruncateParkedResp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.event_store.client.persistent_subscriptions.TruncateParkedResp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.event_store.client.persistent_subscriptions.TruncateParkedResp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
...
proto.event_store.client.persistent_subscriptions.ListReq.Options.toObject = function(includeInstance, msg) {
  var f, obj = {
    listAllSubscriptions: (f = msg.getListAllSubscriptions()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
 ...
 * @return {number}
 */
proto.event_store.client.persistent_subscriptions.ListReq.Options.prototype.getOffset = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.ListReq.Options} returns this
 */
proto.event_store.client.persistent_subscriptions.ListReq.Options.prototype.setOffset = function(value) {
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.ListReq.Options} returns this
 */
proto.event_store.client.persistent_subscriptions.ListReq.Options.prototype.clearOffset = function() {
 ...
 * @return {boolean}
 */
proto.event_store.client.persistent_subscriptions.ListReq.Options.prototype.hasOffset = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {number}
 */
proto.event_store.client.persistent_subscriptions.ListReq.Options.prototype.getCount = function() {
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.ListReq.Options} returns this
 */
proto.event_store.client.persistent_subscriptions.ListReq.Options.prototype.setCount = function(value) {
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.ListReq.Options} returns this
 */
proto.event_store.client.persistent_subscriptions.ListReq.Options.prototype.clearCount = function() {
 ...
 * @return {boolean}
 */
proto.event_store.client.persistent_subscriptions.ListReq.Options.prototype.hasCount = function() {
  return jspb.Message.getField(this, 4) != null;
};
...
proto.event_store.client.persistent_subscriptions.ListReq.StreamOption.toObject = function(includeInstance, msg) {
  var f, obj = {
    stream: (f = msg.getStream()) && event_store_protocols_v1_shared_pb.StreamIdentifier.toObject(includeInstance, f),
    all: (f = msg.getAll()) && event_store_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
 ...
 * @return {number}
 */
proto.event_store.client.persistent_subscriptions.ListResp.prototype.getOffset = function() {
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.ListResp} returns this
 */
proto.event_store.client.persistent_subscriptions.ListResp.prototype.setOffset = function(value) {
  return jspb.Message.setField(this, 2, value);
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.ListResp} returns this
 */
proto.event_store.client.persistent_subscriptions.ListResp.prototype.clearOffset = function() {
 ...
 * @return {boolean}
 */
proto.event_store.client.persistent_subscriptions.ListResp.prototype.hasOffset = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {number}
 */
proto.event_store.client.persistent_subscriptions.ListResp.prototype.getCount = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.ListResp} returns this
 */
proto.event_store.client.persistent_subscriptions.ListResp.prototype.setCount = function(value) {
  return jspb.Message.setField(this, 3, value);
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.ListResp} returns this
 */
proto.event_store.client.persistent_subscriptions.ListResp.prototype.clearCount = function() {
  return jspb.Message.setField(this, 3, undefined);
};
 ...
 * @return {boolean}
 */
proto.event_store.client.persistent_subscriptions.ListResp.prototype.hasCount = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {number}
 */
proto.event_store.client.persistent_subscriptions.ListResp.prototype.getTotal = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.ListResp} returns this
 */
proto.event_store.client.persistent_subscriptions.ListResp.prototype.setTotal = function(value) {
  return jspb.Message.setField(this, 4, value);
};
 ...
 * @return {!proto.event_store.client.persistent_subscriptions.ListResp} returns this
 */
proto.event_store.client.persistent_subscriptions.ListResp.prototype.clearTotal = function() {
  return jspb.Message.setField(this, 4, undefined);
};
 ...
 * @return {boolean}
 */
proto.event_store.client.persistent_subscriptions.ListResp.prototype.hasTotal = function() {
  return jspb.Message.getField(this, 4) != null;
};
