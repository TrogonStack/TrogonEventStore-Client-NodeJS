...
var event_store_protocols_v1_usermanagement_pb = require('../../../event_store/protocols/v1/usermanagement_pb.js');

function serialize_event_store_client_users_ChangePasswordReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.ChangePasswordReq)) {
...
function deserialize_event_store_client_users_ChangePasswordReq(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.ChangePasswordReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_ChangePasswordResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.ChangePasswordResp)) {
...
function deserialize_event_store_client_users_ChangePasswordResp(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.ChangePasswordResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_CreateReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.CreateReq)) {
...
function deserialize_event_store_client_users_CreateReq(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.CreateReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_CreateResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.CreateResp)) {
...
function deserialize_event_store_client_users_CreateResp(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.CreateResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_CurrentReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.CurrentReq)) {
    throw new Error('Expected argument of type event_store.client.users.CurrentReq');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_event_store_client_users_CurrentReq(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.CurrentReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_CurrentResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.CurrentResp)) {
    throw new Error('Expected argument of type event_store.client.users.CurrentResp');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_event_store_client_users_CurrentResp(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.CurrentResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_DeleteReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.DeleteReq)) {
...
function deserialize_event_store_client_users_DeleteReq(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.DeleteReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_DeleteResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.DeleteResp)) {
...
function deserialize_event_store_client_users_DeleteResp(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.DeleteResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_DetailsReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.DetailsReq)) {
...
function deserialize_event_store_client_users_DetailsReq(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.DetailsReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_DetailsResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.DetailsResp)) {
...
function deserialize_event_store_client_users_DetailsResp(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.DetailsResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_DisableReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.DisableReq)) {
...
function deserialize_event_store_client_users_DisableReq(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.DisableReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_DisableResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.DisableResp)) {
...
function deserialize_event_store_client_users_DisableResp(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.DisableResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_EnableReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.EnableReq)) {
...
function deserialize_event_store_client_users_EnableReq(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.EnableReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_EnableResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.EnableResp)) {
...
function deserialize_event_store_client_users_EnableResp(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.EnableResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_ResetPasswordReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.ResetPasswordReq)) {
...
function deserialize_event_store_client_users_ResetPasswordReq(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.ResetPasswordReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_ResetPasswordResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.ResetPasswordResp)) {
...
function deserialize_event_store_client_users_ResetPasswordResp(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.ResetPasswordResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_UpdateReq(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.UpdateReq)) {
...
function deserialize_event_store_client_users_UpdateReq(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.UpdateReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_users_UpdateResp(arg) {
  if (!(arg instanceof event_store_protocols_v1_usermanagement_pb.UpdateResp)) {
...
function deserialize_event_store_client_users_UpdateResp(buffer_arg) {
  return event_store_protocols_v1_usermanagement_pb.UpdateResp.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var UsersService = exports.UsersService = {
  create: {
    ...
    requestType: event_store_protocols_v1_usermanagement_pb.CreateReq,
    responseType: event_store_protocols_v1_usermanagement_pb.CreateResp,
  ...
  update: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: event_store_protocols_v1_usermanagement_pb.UpdateReq,
    responseType: event_store_protocols_v1_usermanagement_pb.UpdateResp,
  ...
  delete: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: event_store_protocols_v1_usermanagement_pb.DeleteReq,
    responseType: event_store_protocols_v1_usermanagement_pb.DeleteResp,
  ...
  disable: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: event_store_protocols_v1_usermanagement_pb.DisableReq,
    responseType: event_store_protocols_v1_usermanagement_pb.DisableResp,
  ...
  enable: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: event_store_protocols_v1_usermanagement_pb.EnableReq,
    responseType: event_store_protocols_v1_usermanagement_pb.EnableResp,
  ...
  current: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: event_store_protocols_v1_usermanagement_pb.CurrentReq,
    responseType: event_store_protocols_v1_usermanagement_pb.CurrentResp,
    requestSerialize: serialize_event_store_client_users_CurrentReq,
    requestDeserialize: deserialize_event_store_client_users_CurrentReq,
    responseSerialize: serialize_event_store_client_users_CurrentResp,
    responseDeserialize: deserialize_event_store_client_users_CurrentResp,
  },
  details: {
    path: '/event_store.client.users.Users/Details',
    requestStream: false,
    responseStream: true,
    requestType: event_store_protocols_v1_usermanagement_pb.DetailsReq,
    responseType: event_store_protocols_v1_usermanagement_pb.DetailsResp,
  ...
  changePassword: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: event_store_protocols_v1_usermanagement_pb.ChangePasswordReq,
    responseType: event_store_protocols_v1_usermanagement_pb.ChangePasswordResp,
  ...
  resetPassword: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: event_store_protocols_v1_usermanagement_pb.ResetPasswordReq,
    responseType: event_store_protocols_v1_usermanagement_pb.ResetPasswordResp,
