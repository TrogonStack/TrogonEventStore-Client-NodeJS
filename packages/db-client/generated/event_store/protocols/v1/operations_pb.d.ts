...
export namespace StartScavengeReq {
    ...
    export class Options extends jspb.Message {
        ...
        setThreshold(value: number): Options;

        hasThrottlePercent(): boolean;
        clearThrottlePercent(): void;
        getThrottlePercent(): number | undefined;
        setThrottlePercent(value: number): Options;
        getSyncOnly(): boolean;
        setSyncOnly(value: boolean): Options;
...
export class ScavengeStatusResp extends jspb.Message {
    getScavengeId(): string;
    setScavengeId(value: string): ScavengeStatusResp;
    getScavengeStatus(): ScavengeStatusResp.ScavengeStatus;
    setScavengeStatus(value: ScavengeStatusResp.ScavengeStatus): ScavengeStatusResp;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): ScavengeStatusResp.AsObject;
    static toObject(includeInstance: boolean, msg: ScavengeStatusResp): ScavengeStatusResp.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: ScavengeStatusResp, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): ScavengeStatusResp;
    static deserializeBinaryFromReader(message: ScavengeStatusResp, reader: jspb.BinaryReader): ScavengeStatusResp;
}

export namespace ScavengeStatusResp {
    export type AsObject = {
        scavengeId: string,
        scavengeStatus: ScavengeStatusResp.ScavengeStatus,
    }

    export enum ScavengeStatus {
    UNKNOWN = 0,
    INPROGRESS = 1,
    STOPPED = 2,
    SUCCESS = 3,
