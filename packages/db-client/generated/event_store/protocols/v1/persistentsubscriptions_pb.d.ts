...
export namespace ReadReq {
    ...
    export class Ack extends jspb.Message {
        ...
        clearIdsList(): void;
        getIdsList(): Array<event_store_protocols_v1_shared_pb.UUID>;
        setIdsList(value: Array<event_store_protocols_v1_shared_pb.UUID>): Ack;
        addIds(value?: event_store_protocols_v1_shared_pb.UUID, index?: number): event_store_protocols_v1_shared_pb.UUID;
    ...
    export namespace Ack {
        export type AsObject = {
            ...
            idsList: Array<event_store_protocols_v1_shared_pb.UUID.AsObject>,
        }
    }
    ...
    export class Nack extends jspb.Message {
        ...
        clearIdsList(): void;
        getIdsList(): Array<event_store_protocols_v1_shared_pb.UUID>;
        setIdsList(value: Array<event_store_protocols_v1_shared_pb.UUID>): Nack;
        addIds(value?: event_store_protocols_v1_shared_pb.UUID, index?: number): event_store_protocols_v1_shared_pb.UUID;
...
export namespace ReadResp {
    ...
    export class ReadEvent extends jspb.Message {
        ...
        getNoRetryCount(): event_store_protocols_v1_shared_pb.Empty | undefined;
        setNoRetryCount(value?: event_store_protocols_v1_shared_pb.Empty): ReadEvent;
    ...
    export namespace ReadEvent {
        export type AsObject = {
            ...
            retryCount: number,
            noRetryCount?: event_store_protocols_v1_shared_pb.Empty.AsObject,
        }
...
export namespace CreateReq {
    ...
    export class AllOptions extends jspb.Message {
        ...
        setNoFilter(value?: event_store_protocols_v1_shared_pb.Empty): AllOptions;
...
export namespace ReplayParkedReq {
    ...
    export class Options extends jspb.Message {
        ...
        hasNoLimit(): boolean;
        clearNoLimit(): void;
        getNoLimit(): event_store_protocols_v1_shared_pb.Empty | undefined;
        setNoLimit(value?: event_store_protocols_v1_shared_pb.Empty): Options;
    ...
    export namespace Options {
        export type AsObject = {
            ...
            all?: event_store_protocols_v1_shared_pb.Empty.AsObject,
            stopAt: string,
            noLimit?: event_store_protocols_v1_shared_pb.Empty.AsObject,
        }
...
export class TruncateParkedReq extends jspb.Message {

    hasOptions(): boolean;
    clearOptions(): void;
    getOptions(): TruncateParkedReq.Options | undefined;
    setOptions(value?: TruncateParkedReq.Options): TruncateParkedReq;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): TruncateParkedReq.AsObject;
    static toObject(includeInstance: boolean, msg: TruncateParkedReq): TruncateParkedReq.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: TruncateParkedReq, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): TruncateParkedReq;
    static deserializeBinaryFromReader(message: TruncateParkedReq, reader: jspb.BinaryReader): TruncateParkedReq;
}

export namespace TruncateParkedReq {
    export type AsObject = {
        options?: TruncateParkedReq.Options.AsObject,
    }
...
export class TruncateParkedResp extends jspb.Message {

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): TruncateParkedResp.AsObject;
    static toObject(includeInstance: boolean, msg: TruncateParkedResp): TruncateParkedResp.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: TruncateParkedResp, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): TruncateParkedResp;
    static deserializeBinaryFromReader(message: TruncateParkedResp, reader: jspb.BinaryReader): TruncateParkedResp;
}

export namespace TruncateParkedResp {
    export type AsObject = {
    }
}
...
export namespace ListReq {
    ...
    export class Options extends jspb.Message {
        ...
        getListAllSubscriptions(): event_store_protocols_v1_shared_pb.Empty | undefined;
        setListAllSubscriptions(value?: event_store_protocols_v1_shared_pb.Empty): Options;
        ...
        setOffset(value: number): Options;
    ...
    export namespace Options {
        export type AsObject = {
            listAllSubscriptions?: event_store_protocols_v1_shared_pb.Empty.AsObject,
    ...
    export class StreamOption extends jspb.Message {
        ...
        hasStream(): boolean;
        clearStream(): void;
        getStream(): event_store_protocols_v1_shared_pb.StreamIdentifier | undefined;
        setStream(value?: event_store_protocols_v1_shared_pb.StreamIdentifier): StreamOption;

        hasAll(): boolean;
        clearAll(): void;
        getAll(): event_store_protocols_v1_shared_pb.Empty | undefined;
        setAll(value?: event_store_protocols_v1_shared_pb.Empty): StreamOption;
    ...
    export namespace StreamOption {
        export type AsObject = {
            stream?: event_store_protocols_v1_shared_pb.StreamIdentifier.AsObject,
            all?: event_store_protocols_v1_shared_pb.Empty.AsObject,
        }
...
export class ListResp extends jspb.Message {
    ...
    clearOffset(): void;
    getOffset(): number | undefined;
    setOffset(value: number): ListResp;

    hasCount(): boolean;
    clearCount(): void;
    getCount(): number | undefined;
    setCount(value: number): ListResp;

    hasTotal(): boolean;
    clearTotal(): void;
    getTotal(): number | undefined;
    setTotal(value: number): ListResp;
